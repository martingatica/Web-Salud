...
const PasskeyModal = () => {
  ...
  const encryptedKey = typeof window !== "undefined" ? window.localStorage.getItem("accessKey") : _N_E_STYLE_LOAD;
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent className='shad-alert-dialog'>
            ...
            <div>
                ...
                {error && <p className='shad-error text-14-regular mt-14 flex'>
                    {error}
                    </p>}
            </div>
